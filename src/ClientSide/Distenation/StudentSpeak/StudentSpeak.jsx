...
const StudentSpeak = () => {
  ...
  return (
          ...
          <div>
            <div className="xl:mx-[432px]  lg:mx-[200px]  text-center py-8 z-10 relative text-white translate-y-[50px]">
              ...
              <p className="font-normal text-[16px] leading-[24px] text-white/[.8]">
                Study Globe truly made my dream of studying abroad a reality.
                Their team guided me through every step, from choosing the right
                university to ensuring a smooth visa process. I couldn't have
                done it without their constant support.
              </p>
            </div>
    ...
    xs:text-[14px] xs:leading-[21px] xxs:text-[12px] xxs:leading-[18px]  text-white/[.8]"
                >
                  Study Globe truly made my dream of studying abroad a reality.
                  Their team guided me through every step, from choosing the
                  right university to ensuring a smooth visa process. I couldn't
