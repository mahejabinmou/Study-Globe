...
const HeroSection = () => {
  ...
  const studyMobileRef = useRef(null);
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      studyMobileRef.current.children,
      { opacity: 0, x: -20 },
      {
        opacity: 1,
        x: 0,
        ...
        >
          <div>
            ...
            <h1 className="homeHead text-[#F6941E] md:pb-[15px]">
              <span ref={studyMobileRef}>
                {"Study Globe".split("").map((char, index) => (
                  <span key={index}>{char}</span>
                ))}
              </span>
            </h1>
          ...
          <p className="pb-[30px] homePara  text-white   max-w-[332px]">
            Choose study For Your Study Abroad Journey & Embark on An
        ...
        <div className="  ">
          <div className="absolute  z-10 font-helvetica  xl:ml-[150px] md:mt-[150px] lg:mt-[100px]  lg:ml-[60px] md:ml-[80px] ml-[60px]">
            <div>
              ...
              {/* "Study Globe" text in orange - second line */}
