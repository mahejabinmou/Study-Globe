...
const Footer = () => {
  ...
  return (
    // bg-[#1E1E1E]
    <div className=" bg-[#F6941E]/[.2] text-black sectionGap">
      {/* foooter content */}
              ...
              <div>
                ...
                <div className=" ">
                  <p className="text-[12px] leading-[16px] pb-[16px] font-helvetica font-normal">
                    Copyright © {new Date().getFullYear()} Study Globe. All
                ...
                <div className=" ">
                  <div className="flex pb-[15px] gap-x-[10px]">
                    <a
                      href="https://www.facebook.com/studyglobe"
                      target="_blank"
                    ...
                    <a
                      href="https://www.instagram.com/studyglobe"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    ...
                    <a
                      href="https://www.linkedin.com/in/studyglobe/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <div className="text-black ">
              ...
              <div className="grid grid-cols-2 gap-10">
                <div className="flex items-start gap-x-[10px]">
                  ...
                  <span className=" footerMenuText ">
                    ...
                    <br />
                    Kha-12/2, Shahjaspur, Gulshan, Dhaka-1212road 2, mirpur,
                    Dhaka-1212
                  </span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-10">
                <p className="flex items-start gap-x-[10px]">
                  ...
                  <span className=" footerMenuText ">
                    ...
                    <br />
                    00 -00 20 Rd St (2nd floor), Jackson Heights NY, 0000
                  </span>
                </p>
                <p className="flex flex-row gap-x-[5px]">
                  <LazyLoadImage
              ...
              <div className="grid grid-cols-2 gap-10">
                <p className="flex items-start gap-x-[10px]">
                  ...
                  <span className=" footerMenuText ">
                    ...
                    <br />
                    0/0 Nellie Ave Mitchell, Park SA, 5043
                  </span>
                </p>
                <p className="flex flex-row gap-x-[5px]">
                  <LazyLoadImage
              ...
              <div>
                <p className="footerMenuText flex pl-[8px]  gap-x-[10px] pt-3">
                  ...
                  <span> info@studyglobe.com.bd</span>
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                <p className="2xl:text-[12px] text-[10px] leading-[20px] pb-[16px] font-helvetica font-normal">
                  Copyright © {new Date().getFullYear()} Study Globe. All rights
                  reserved. Excellence in guidance and commitment to success.
                </p>
              </div>
